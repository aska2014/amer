...
abstract class User extends Model implements UserInterface, RemindableInterface {
     ...
     * @var string
     */
    protected $table = 'ka_user_accounts';
     ...
     * @var array
     */
    protected $infoAttributes = array();
    ...
    public function getAttribute( $key )
    {
        ...
        return $this->getInfoAttribute( $key );
    }

    /**
     * Get user information attribute by key
     *
     * @param $key
     * @return string
     */
    public function getInfoAttribute( $key )
    {
    ...
    /**
     * Get all users by recipient model
     *
     * @param Model $model
     * @return Collection
     */
    ...
    /**
     * Get all users by the given creation model.
     *
     * @param Model $model
     * @return Collection
     */
