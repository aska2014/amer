...
class Element implements DefaultInterface {
    ...
    public function useDefaults()
    {
        ...
        $this->setMenuItem(Item::make(
            ...
            Item::make('Add new ' . strtolower($this->getName()), $this->getUri('create'), Icon::make('icol-add')),
            Item::make('Display all ' . strtolower(Str::plural($this->getName())), $this->getUri(), Icon::make('icol-inbox'))
        )));
