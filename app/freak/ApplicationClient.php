...
class ApplicationClient extends Freak\Core\Client {
    ...
    public function run(Freak $freak)
    {
        ...
        $freak->modifyElement('contactInfo', function(Element $element)
        {
            $element->setMenuItem(Item::make(
                'Contact Info', '', Icon::make('icon-archive')
            )->addChildren(array(
        ...
        {
            $element->setMenuItem(Item::make(
                'Users', '', Icon::make('icon-archive')
            )->addChildren(array(
                    Item::make('Display all users', $element->getUri(), Icon::make('icol-group')),
                )));
